...
namespace QuanLyBanHang
{
    ...
    {
        //Chuỗi kết nối
        string strConnectionString = @"Data Source=DESKTOP-16DIK75;Initial Catalog=QuanLyBanHang;Integrated Security=True";
        //Đối tượng kết nối
            ...
            try
            {
                ...
                switch (intDM)
                {
                    ...
                    case 2:
                        ...
                        daTable = new SqlDataAdapter("select MaKH, TenCTy, DiaChi, ThanhPho, DienThoai from KHACHHANG", conn);
                        break;
                    case 3:
